...
| freq9999hz.m4a | "9.999 Hz" — value: 9.999 | OK (status incorreto) | "9.999 Hz" — value: 9999 | INVALIDO |
| doiscomandos.m4a | "para 5 e para 120" — perde pressão | OK (status incorreto) | "para 5 e pressão para 120" | AMBIGUO |
